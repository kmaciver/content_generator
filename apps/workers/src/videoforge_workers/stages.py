...
from videoforge_providers.models import LLMMessage, LLMRequest, LLMResult
...
def llm_complete(prompt: RenderedPrompt, schema: dict[str, Any]) -> LLMResult:
    """One completion from a rendered prompt.
